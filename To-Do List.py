...
if __name__ == "__main__":  
    ...
    guiWindow.title("To-Do List Manager - PYTHON")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#153677")  
    functions_frame = tk.Frame(guiWindow, bg = "#153677")  
    listbox_frame = tk.Frame(guiWindow, bg = "#153677")  
